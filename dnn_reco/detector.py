...
# flattened IC78 coordinates: shape [10*10*60*3]
x_ic78_coords_flat = [
    0.0,
    0.0,
    0.0,
...
# IC78 coordinates: shape [10, 10, 60, 3]
x_ic78_coords = np.reshape(x_ic78_coords_flat, [10, 10, 60, 3])
...
ic78_real_DOMs_mask = np.zeros((10, 10, 60), dtype=bool)
for string, (a, b) in string_hex_coord_dict.items():
    ic78_real_DOMs_mask[a + 4, b + 5, :] = True
