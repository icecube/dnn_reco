...
# Gather keys
FINAL_OUT=./temp_step_files/NuGen/NuTau/low_energy/IC86_2013_holeice_30_v4/l5/1/DNN_l5_00000002_step0000
I3_ENDING=i3.bz2
...
then
    ...
    /data/user/mhuennefeld/software/repositories/dnn_recoV2compatV1/tests_manual/test_data/dnn_reco_test_01/processing/NuGen/NuTau/low_energy/IC86_2013_holeice_30_v4/l5/processing_steps_0001/general_i3_processing_step_0000.py /data/user/mhuennefeld/software/repositories/dnn_recoV2compatV1/tests_manual/test_data/dnn_reco_test_01/processing/NuGen/NuTau/low_energy/IC86_2013_holeice_30_v4/l5/processing_steps_0001/test_data_cfg_step_0000.yaml 2 --scratch
    JOB_RC=$?
    echo 'Job finished with Exit Code: ' $JOB_RC
    if [ $JOB_RC -eq 0 ] || [ "$KEEP_CRASHED_FILES" = "True" ]; then

        # create output folder
        mkdir -p ./temp_step_files/NuGen/NuTau/low_energy/IC86_2013_holeice_30_v4/l5/1

        if [ "$WRITE_HDF5" = "True" ]; then
            cp DNN_l5_00000002_step0000.hdf5 ./temp_step_files/NuGen/NuTau/low_energy/IC86_2013_holeice_30_v4/l5/1
        fi
        if [ "$WRITE_I3" = "True" ]; then
            cp DNN_l5_00000002_step0000.${I3_ENDING} ./temp_step_files/NuGen/NuTau/low_energy/IC86_2013_holeice_30_v4/l5/1
        fi
        if [ -f "$FINAL_OUT" ]; then
            cp DNN_l5_00000002_step0000 ./temp_step_files/NuGen/NuTau/low_energy/IC86_2013_holeice_30_v4/l5/1
        fi
    fi
