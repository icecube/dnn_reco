...
# Gather keys
FINAL_OUT=/data/user/mhuennefeld/software/repositories/dnn_recoV2compatV1/tests_manual/test_data/dnn_reco_test_01/NuGen/NuE/low_energy/IC86_2013_holeice_30_v4/l5/1/DNN_l5_00000002
I3_ENDING=i3.bz2
...
then
    ...
    /data/user/mhuennefeld/software/repositories/dnn_recoV2compatV1/tests_manual/test_data/dnn_reco_test_01/processing/NuGen/NuE/low_energy/IC86_2013_holeice_30_v4/l5/processing_steps_0000/general_i3_processing_step_0001.py /data/user/mhuennefeld/software/repositories/dnn_recoV2compatV1/tests_manual/test_data/dnn_reco_test_01/processing/NuGen/NuE/low_energy/IC86_2013_holeice_30_v4/l5/processing_steps_0000/test_data_cfg_step_0001.yaml 2 --no-scratch
    JOB_RC=$?
    ...
    if [ $JOB_RC -eq 0 ] || [ "$KEEP_CRASHED_FILES" = "True" ]; then
        ...
        mkdir -p /data/user/mhuennefeld/software/repositories/dnn_recoV2compatV1/tests_manual/test_data/dnn_reco_test_01/NuGen/NuE/low_energy/IC86_2013_holeice_30_v4/l5/1

        if [ "$WRITE_HDF5" = "True" ]; then
            cp DNN_l5_00000002.hdf5 /data/user/mhuennefeld/software/repositories/dnn_recoV2compatV1/tests_manual/test_data/dnn_reco_test_01/NuGen/NuE/low_energy/IC86_2013_holeice_30_v4/l5/1
        fi
        if [ "$WRITE_I3" = "True" ]; then
            cp DNN_l5_00000002.${I3_ENDING} /data/user/mhuennefeld/software/repositories/dnn_recoV2compatV1/tests_manual/test_data/dnn_reco_test_01/NuGen/NuE/low_energy/IC86_2013_holeice_30_v4/l5/1
        fi
        if [ -f "$FINAL_OUT" ]; then
            cp DNN_l5_00000002 /data/user/mhuennefeld/software/repositories/dnn_recoV2compatV1/tests_manual/test_data/dnn_reco_test_01/NuGen/NuE/low_energy/IC86_2013_holeice_30_v4/l5/1
        fi
    fi
