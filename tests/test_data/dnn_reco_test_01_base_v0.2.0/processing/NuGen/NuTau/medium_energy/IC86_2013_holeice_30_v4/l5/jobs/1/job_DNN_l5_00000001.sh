...
then
    ...
    /data/user/mhuennefeld/scripts/processing_scripts/processing/scripts/dnn_reco_create_data.py /data/user/mhuennefeld/to_delete/unit_tests/dnn_reco_test_01_base/processing/NuGen/NuTau/medium_energy/IC86_2013_holeice_30_v4/l5/dnn_reco_test_01_base.yaml_0001 1 --no-scratch
    ICETRAY_RC=$?
    ...
    /data/user/mhuennefeld/scripts/processing_scripts/processing/scripts/dnn_reco_create_data.py /data/user/mhuennefeld/to_delete/unit_tests/dnn_reco_test_01_base/processing/NuGen/NuTau/medium_energy/IC86_2013_holeice_30_v4/l5/dnn_reco_test_01_base.yaml_0001 1 --scratch
    ICETRAY_RC=$?
    echo 'IceTray finished with Exit Code: ' $ICETRAY_RC
