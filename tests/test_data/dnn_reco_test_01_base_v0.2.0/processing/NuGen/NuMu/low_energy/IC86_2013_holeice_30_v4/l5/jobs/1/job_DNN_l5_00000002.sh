...
#PBS -o /data/user/mhuennefeld/to_delete/unit_tests/dnn_reco_test_01_base/processing/NuGen/NuMu/low_energy/IC86_2013_holeice_30_v4/l5/logs/1/run_2_${PBS_JOBID}.out
#PBS -e /data/user/mhuennefeld/to_delete/unit_tests/dnn_reco_test_01_base/processing/NuGen/NuMu/low_energy/IC86_2013_holeice_30_v4/l5/logs/1/run_2_${PBS_JOBID}.err
#PBS -q long
#PBS -S /cvmfs/icecube.opensciencegrid.org/py2-v3.0.1/icetray-start
FINAL_OUT=/data/user/mhuennefeld/to_delete/unit_tests/dnn_reco_test_01_base/NuGen/NuMu/low_energy/IC86_2013_holeice_30_v4/l5/1/DNN_l5_00000002
...
then
    ...
    if [ $ICETRAY_RC -eq 0 ] || [ $KEEP_CRASHED_FILES -eq 1 ]; then
        if [ "$WRITE_HDF5" = "True" ]; then
            cp *.hdf5 /data/user/mhuennefeld/to_delete/unit_tests/dnn_reco_test_01_base/NuGen/NuMu/low_energy/IC86_2013_holeice_30_v4/l5/1
        fi
        if [ "$WRITE_I3" = "True" ]; then
            cp *.i3.bz2 /data/user/mhuennefeld/to_delete/unit_tests/dnn_reco_test_01_base/NuGen/NuMu/low_energy/IC86_2013_holeice_30_v4/l5/1
        fi
    fi
